...
public class DefaultXBuilder implements XBuilder {
    ...
    void configureEngine(@Observes EngineBuilder builder) {
        builder.addResultMapper(new HtmlEscaper(List.of("text/html", "text/xml", "application/xml", "application/xhtml+xml")));

        EngineProducer.getInstance()
                .getEngine()
                .getValueResolvers()
                .forEach(builder::addValueResolver);
    }
